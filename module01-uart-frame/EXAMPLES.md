# Module 01 examples — UART frame

Track A (UART RTL / TB literacy). Browser lab **`uart-frame`** is shipped.
...
When ready, redo the same idea in the **`uart-frame`** starter challenges.
