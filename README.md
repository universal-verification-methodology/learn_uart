...
|-------|------------------|------------|
| **A — Real RTL/TB** | Paper + `.v` · [`../learn_uart_spi_i2c`](../learn_uart_spi_i2c/) | [docs/TWO_TRACKS.md](docs/TWO_TRACKS.md) |
